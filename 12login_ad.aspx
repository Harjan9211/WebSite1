<%@ Page Language="C#" AutoEventWireup="true" CodeFile="12login_ad.aspx.cs" Inherits="Default2" %>
...
<body>        
    ...
    <tr><td>
        <br />
                Student's Accounts Waiting for your approvel<br></td><td valign="top" align="right"><font face="tahoma" color="blue"><small><a href="14ad_login.aspx">Show all Active Accounts</a><br /><a href="21feedbackview.aspx">User Feedback</a></small></font></td></tr> 
    
    <tr><td><i><small>
        <br />
        (to approve account press Edit and set status 1)</small><br />
        </i>&nbsp;
    </td><td></td></tr>   
    ...
    <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="0" Name="Ac_states" Type="Int32" />
        </SelectParameters>
        <DeleteParameters>
